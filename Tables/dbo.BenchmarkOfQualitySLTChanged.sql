CREATE TABLE [dbo].[BenchmarkOfQualitySLTChanged]
(
[BenchmarkOfQualitySLTChangedPK] [int] NOT NULL IDENTITY(1, 1),
...
GO
ALTER TABLE [dbo].[BenchmarkOfQualitySLTChanged] ADD CONSTRAINT [PK_BenchmarkOfQualitySLTChanged] PRIMARY KEY CLUSTERED ([BenchmarkOfQualitySLTChangedPK]) ON [PRIMARY]
GO
