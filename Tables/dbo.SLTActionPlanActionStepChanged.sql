CREATE TABLE [dbo].[SLTActionPlanActionStepChanged]
(
[SLTActionPlanActionStepChangedPK] [int] NOT NULL IDENTITY(1, 1),
...
GO
ALTER TABLE [dbo].[SLTActionPlanActionStepChanged] ADD CONSTRAINT [PK_SLTActionPlanActionStepChanged] PRIMARY KEY CLUSTERED ([SLTActionPlanActionStepChangedPK]) ON [PRIMARY]
GO
