CREATE TABLE [dbo].[SLTMemberChanged]
(
[SLTMemberChangedPK] [int] NOT NULL IDENTITY(1, 1),
...
GO
ALTER TABLE [dbo].[SLTMemberChanged] ADD CONSTRAINT [PK_SLTMemberChanged] PRIMARY KEY CLUSTERED ([SLTMemberChangedPK]) ON [PRIMARY]
GO
