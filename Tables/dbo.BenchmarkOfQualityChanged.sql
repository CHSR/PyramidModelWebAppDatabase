CREATE TABLE [dbo].[BenchmarkOfQualityChanged]
(
[BenchmarkOfQualityChangedPK] [int] NOT NULL IDENTITY(1, 1),
...
GO
ALTER TABLE [dbo].[BenchmarkOfQualityChanged] ADD CONSTRAINT [PK_BenchmarkOfQualityChanged] PRIMARY KEY CLUSTERED  ([BenchmarkOfQualityChangedPK]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_BenchmarkOfQualityChanged_BenchmarkOfQualityPK_ChangeDatetime] ON [dbo].[BenchmarkOfQualityChanged] ([BenchmarkOfQualityPK], [ChangeDatetime] DESC) ON [PRIMARY]
GO
