...
-- Job Function section of the Employee Data Dump report
-- =============================================
CREATE PROC [dbo].[rspProgramEmployeeDataDump_JobFunctions]
...
BEGIN
    ...
    FROM dbo.JobFunction jf
		INNER JOIN dbo.CodeJobType cjt
			ON cjt.CodeJobTypePK = jf.JobTypeCodeFK
		INNER JOIN dbo.ProgramEmployee pe
			ON pe.ProgramEmployeePK = jf.ProgramEmployeeFK
