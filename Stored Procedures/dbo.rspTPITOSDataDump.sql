...
-- TPITOS section of the TPITOS Data Dump report
-- =============================================
CREATE PROC [dbo].[rspTPITOSDataDump]
...
BEGIN
    ...
    SELECT tp.TPITOSPK,
		   ...
		   tp.LeadTeacherRedFlagsNumPossible,
		   tp.LeadTeacherRedFlagsNumYes,
		   tp.ClassroomFK,
		   tp.ObserverFK,
		   tp.OtherTeacherRedFlagsNumYes,
		   tp.OtherTeacherRedFlagsNumPossible,
		   tp.ClassroomRedFlagsNumYes,
		   tp.ClassroomRedFlagsNumPossible,
