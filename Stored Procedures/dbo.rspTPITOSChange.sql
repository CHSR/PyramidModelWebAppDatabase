...
BEGIN
    ...
    SELECT typPrev.CodeTPITOSKeyPracticeFK,
    ...
    FROM @tblYearlyPercentage typPrev
        LEFT JOIN @tblYearlyPercentage typNext
            ON typNext.CodeTPITOSKeyPracticeFK = typPrev.CodeTPITOSKeyPracticeFK
    ...
    SELECT CodeTPITOSKeyPracticeFK,
           AVG(PctYesDiff)
    FROM @tblYearlyPercentageDifference typd
    GROUP BY typd.CodeTPITOSKeyPracticeFK;
    ...
    SELECT typd.CodeTPITOSKeyPracticeFK,
           ctkp.Description,
           typd.TimeSpan,
           typd.PctYesDiff,
           typd.MinDate,
    ...
    FROM @tblYearlyPercentageDifference typd
        INNER JOIN @tblAverage ta
            ON ta.CodeTPITOSKeyPracticeFK = typd.CodeTPITOSKeyPracticeFK
        INNER JOIN dbo.CodeTPITOSKeyPractice ctkp
            ON ctkp.CodeTPITOSKeyPracticePK = typd.CodeTPITOSKeyPracticeFK;
END;
GO
