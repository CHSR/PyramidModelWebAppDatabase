...
-- Description:	Percentage of 'Yes' for each TPITOS Key Practice.
-- =============================================
CREATE PROC [dbo].[rspTPITOSKeyPracticeCounts]
    @StartDate DATETIME,
    @EndDate DATETIME,
...
INSERT INTO 
	@tblResults (CodeTPITOSKeyPracticeFK, PctYes, CntYes, CntNo)
SELECT 
	1
...
UPDATE @tblResults SET CntTPITOS = (SELECT COUNT(*) FROM @tblCohort)
...
SELECT 
	   ...
	   INNER JOIN CodeTPITOSKeyPractice c ON CodeTPITOSKeyPracticeFK = c.CodeTPITOSKeyPracticePK ORDER BY PctYes desc
END;
